...
public class Messages {
    ...
    public static final String CLIENT_ID_URGENT = "Client ID cannot be null";
    public static final String FROM_WHERE = "From location must not be blank";
    public static final String TO_WHERE = "To location must not be blank";
    public static final String INVALID_DEPARTURE_DATE = "Departure date must be in the future";
